      ...
      <footer className="border-t border-slate-200 bg-white py-8 text-center text-xs text-slate-500">
        <div className="mx-auto max-w-7xl px-4 space-y-4">
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs font-bold text-slate-700">
            ...
            <button onClick={() => { setCurrentTab("creator"); window.scrollTo({ top: 0, behavior: "smooth" }); }} className="text-amber-900 font-extrabold hover:underline cursor-pointer">About Creator: Hamid Ali</button>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-3 border-t border-slate-100">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2">
              <span className="font-bold text-slate-800">
                Vocabino • Official IELTS Academic Examination Institute
              </span>
              <span className="hidden sm:inline text-slate-300">•</span>
              <button
                onClick={() => { setCurrentTab("creator"); window.scrollTo({ top: 0, behavior: "smooth" }); }}
                className="font-bold text-amber-950 bg-amber-50 px-2 py-0.5 rounded border border-amber-200 hover:bg-amber-100 transition cursor-pointer"
                title="View full biography and works of Hamid Ali"
              >
